...
export { createTyped } from './core/function/typed.js'; // classes
...
export var createDivide = /* #__PURE__ */createNumberFactory('divide', divideNumber); // bitwise
...
export var createRightLogShift = /* #__PURE__ */createNumberFactory('rightLogShift', rightLogShiftNumber); // combinatorics
...
export { createComposition } from './function/combinatorics/composition.js'; // constants
...
createSQRT2, createTau, createTrue, createVersion } from './constants.js'; // create

export { createNumber } from './type/number.js';
export { createString } from './type/string.js';
export { createBoolean } from './type/boolean.js';
export { createParser } from './expression/function/parser.js'; // expression
...
export { createParserClass } from './expression/Parser.js'; // logical
...
export var createXor = /* #__PURE__ */createNumberFactory('xor', xorNumber); // matrix
...
export { createSize } from './function/matrix/size.js'; // FIXME: create a lightweight "number" implementation of subset only supporting plain objects/arrays
...
export var createSubset = /* #__PURE__ */factory('subset', [], () => noSubset); // TODO: provide number+array implementations for map, filter, forEach, zeros, ...?
// TODO: create range implementation for range?

export { createPartitionSelect } from './function/matrix/partitionSelect.js'; // probability
...
export { createRandomInt } from './function/probability/randomInt.js'; // relational
...
export { createUnequalNumber as createUnequal } from './function/relational/unequal.js'; // special

export { createErf } from './function/special/erf.js'; // statistics
...
export { createStd } from './function/statistics/std.js'; // string

export { createFormat } from './function/string/format.js';
export { createPrint } from './function/string/print.js'; // trigonometry
...
export var createTanh = /* #__PURE__ */createNumberFactory('tanh', tanhNumber); // transforms
